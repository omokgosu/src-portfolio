    ...
    return (
      <header className={isNavOpen ? 'header on' : 'header'}>
        <div className="headerInner">
            <h1 className={is1400 ? 'hidden' : ''}><a href="https://saferoadclub.app/"><span className="hidden">SRC 로고</span></a></h1>
            ...
            <div className={isNavOpen ? 'menu on' : 'menu'}>
              <div className="menuInner">
                <nav>
                    ...
                    <ul>
                        <li><a href="https://saferoadclub.app/" onClick={toggleNav}><span>HOME</span></a></li>
